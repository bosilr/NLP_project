...
###############################################################################################################
    ...
    # book = readWholeBook("../data/books/ASongOfIceAndFire/ACOK/chapters/")
    ...
    main_characters_dict = get_main_characters("../results/books/ASongOfIceAndFire/ASOS/unique_names", number_of_characters, exclude, chapters=False)
    ...
    save_file_sent = "../results/books/ASongOfIceAndFire/ASOS/sentiment/normal/" + ana_type + "/sentiment_chapters_whole.png"
    save_file_coo = "../results/books/ASongOfIceAndFire/ASOS/sentiment/normal/" + ana_type + "/coocurance_chapters_whole.png"

    title1 = "Relationship graph: ASOS whole book"
    title2 = "Cooccurrence graph: ASOS whole book"
